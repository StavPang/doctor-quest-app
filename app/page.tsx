  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800 py-8 px-4">
      <div className="max-w-4xl mx-auto">
        {/* Header */}
        <div className="bg-slate-800 rounded-t-2xl shadow-2xl p-6 border-b-2 border-cyan-500/30">
          ...
          <p className="text-center text-gray-400">Ερωτήσεις Ιατρικής</p>
          ...
          <div className="mt-4 flex items-center justify-center gap-2">
            ...
            <select
              ...
              className="px-4 py-2 bg-slate-700 border border-slate-600 text-gray-200 rounded-lg focus:ring-2 focus:ring-cyan-500 focus:border-cyan-500 outline-none"
            >
        ...
        {/* Question Card */}
        <div className="bg-slate-800 shadow-2xl p-8 border-x border-slate-700">
          <div className="mb-4">
          ...
          <h2 className="text-xl font-semibold text-gray-100 mb-6 leading-relaxed">
              ...
              return (
                ...
                >
                  <div className="flex items-start">
                    ...
                    <span className="flex-1 pt-1 text-gray-200">{option.value}</span>
                  </div>
                </button>
              )
            })}
        ...
        {/* Navigation */}
        <div className="bg-slate-800 rounded-b-2xl shadow-2xl p-6 border-t-2 border-cyan-500/30">
          <div className="flex gap-3 justify-between items-center">
            <button
              onClick={handlePrevious}
              disabled={currentIndex === 0}
              className="px-6 py-3 bg-slate-700 text-gray-300 rounded-lg font-medium hover:bg-slate-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors border border-slate-600"
            >
              ← Προηγούμενη
            </button>
            ...
            <div className="flex gap-3">
              {!showResult ? (
                <button
                  ...
                  className="px-8 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg font-medium hover:from-cyan-600 hover:to-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-cyan-500/20"
                >
                  Υποβολή
                </button>
              ) : (
                <button
                  onClick={handleReset}
                  className="px-6 py-3 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-lg font-medium hover:from-purple-600 hover:to-pink-600 transition-all shadow-lg shadow-purple-500/20"
                >
                  Επανεκκίνηση
                </button>
              )}
        ...
        {/* Stats Summary */}
        {answeredQuestions > 0 && (
          <div className="mt-6 bg-slate-800 rounded-2xl shadow-2xl p-6 border border-slate-700">
            <h3 className="text-lg font-semibold text-gray-200 mb-3">Στατιστικά</h3>
            <div className="grid grid-cols-3 gap-4 text-center">
              <div>
                <p className="text-2xl font-bold text-cyan-400">{answeredQuestions}</p>
                <p className="text-sm text-gray-400">Απαντήθηκαν</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-emerald-400">{score}</p>
                <p className="text-sm text-gray-400">Σωστές</p>
              </div>
              <div>
                <p className="text-2xl font-bold text-purple-400">
                  {answeredQuestions > 0 ? Math.round((score / answeredQuestions) * 100) : 0}%
                </p>
                <p className="text-sm text-gray-400">Ποσοστό</p>
              </div>
            </div>
          </div>
        )}
